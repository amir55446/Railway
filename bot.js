...
// ⚙️  إعدادات البوت
// ============================================================
const BOT_NUMBER    = '201038075394';   // رقم البوت
...
function downloadYouTubeAudio(songName) {
  return new Promise((resolve, reject) => {
    ...
    const attempts = [
      ...
      {
        label: 'YouTube web_embedded',
        cmd: `${base} ${commonFlags}--extractor-args "youtube:player_client=web_embedded" -o "${outputTemplate}" "ytsearch1:${safeName}"`,
      },
      {
        label: 'YouTube web_creator',
        cmd: `${base} ${commonFlags}--extractor-args "youtube:player_client=web_creator" -o "${outputTemplate}" "ytsearch1:${safeName}"`,
      },
      {
        label: 'YouTube android',
        cmd: `${base} ${commonFlags}--extractor-args "youtube:player_client=android" -o "${outputTemplate}" "ytsearch1:${safeName}"`,
      },
    ];
